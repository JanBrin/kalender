...
typedef TileBuilder<T extends CalendarEvent<T>> = Widget Function(
  T event,
...
///
/// [event] is the event that the tile will be built for.
typedef TileWhenDraggingBuilder<T extends CalendarEvent<T>> = Widget Function(
  T event,
);
...
typedef FeedbackTileBuilder<T extends CalendarEvent<T>> = Widget Function(
  T event,
...
///
/// [event] is the event that the tile will be built for.
typedef TileDropTargetBuilder<T extends CalendarEvent<T>> = Widget Function(
  T event,
);
...
class TileComponents<T extends CalendarEvent<T>> {
